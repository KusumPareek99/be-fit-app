...
class CurvesPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(size.width * 0.10, size.height * 0.80, size.width * 0.15, size.height * 0.70);
    path.quadraticBezierTo(size.width * 0.20, size.height * 0.55, size.width * 0.27, size.height * 0.65);
    ...
    path.quadraticBezierTo(size.width * 0.85, size.height * 0.93, size.width, size.height * 0.7);
    ...
    path = Path();
    path.lineTo(0, size.height * 0.75);
    path.quadraticBezierTo(size.width * 0.10, size.height * 0.45, size.width * 0.20, size.height * 0.70);
